...
class DiscoverFragment : Fragment(), OnTvShowClickListener {
    ...
    override fun onCreateView(
        ...
        binding.recyclerView.adapter = TrendingAdapter(this)

        viewModel.airingToday.observe(viewLifecycleOwner, Observer {
            (binding.recyclerView.adapter as TrendingAdapter).setData(it)
        })
